...
- **[OneXPlayer](plugins/apex/README.md)** — OneXPlayer device fixes: recover the internal gamepad when its xHCI controller dies on resume, and block the fingerprint reader from waking the device on a light touch
...
- **[Vibration](plugins/vibration/README.md)** — Global rumble intensity for OneXPlayer-family handhelds, via the hid-oxp kernel driver
