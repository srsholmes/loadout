...
// The vulkanCheck / checkingVulkan state lives inside this component
// — it's strictly local to the diagnostics flow and the parent has
...
// `flashStatus` is the auto-clearing status-banner helper, owned by
// the parent. Verbose logging delegates back to the shared
// `onUpdateSetting` so it stays in sync with the rest of the settings.
//
