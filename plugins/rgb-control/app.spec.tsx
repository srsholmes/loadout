...
// Captured BEFORE mock.module() runs, so this holds the real module
// for the partial-mock spread. (bun's mock.module is not hoisted, so
// the static import evaluates first.)
import * as actualUi from "@loadout/ui";
import { fireEvent, waitFor } from "../../test/render";

const callMock = mock((_method: string) => Promise.resolve<unknown>(null));
