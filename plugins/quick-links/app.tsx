...
// Pure URL/chip helpers live in lib/quick-links.ts so bun:test can
// exercise them without React (see `lib/quick-links.test.ts`).
import { buildChips, isSteamApp } from "./lib/quick-links";
...
export const mount = mountComponent(QuickLinksPanel);
export const mountHomeWidget = mountComponent(QuickLinksHomeWidget);
