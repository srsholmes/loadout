...
describe("macFromDevicePath", () => {
  it("extracts and colon-formats the MAC", () => {
    expect(macFromDevicePath("/org/bluez/hci0/dev_98_7A_14_88_C5_77")).toBe(
      "98:7A:14:88:C5:77",
    );
  });
...
describe("devicePathFromMac", () => {
  it("builds the object path under an adapter", () => {
    expect(devicePathFromMac("/org/bluez/hci0", "98:7A:14:88:C5:77")).toBe(
      "/org/bluez/hci0/dev_98_7A_14_88_C5_77",
    );
  });
