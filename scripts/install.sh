...
# the tree: prefer the staged tree (if live is missing, staging was
# already fully downloaded + checksum-verified — completing the update),
# else fall back to the previous generation.
